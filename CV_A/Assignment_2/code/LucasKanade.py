...
def strat3(It0, It1, rect, template_rect, 
    ...
    if img_index == 1:
        ...
        # if start3 equation is not satisfied
            ...
            p_n_final = np.array([0.0, 0.0])
            new_template_img_id = template_index
    
    return p_n_final, new_template_img_id