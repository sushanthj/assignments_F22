...
def main():
    ...
    print("Inverse Composition Returned Matrix ", M)
...
def InverseCompositionAffine(It, It1, threshold, num_iters):
    ...
    dx_template_crop = scipy.ndimage.affine_transform(dx_template_crop.T,M).T
    dy_template_crop = interpolant_It.ev(xx, yy, dx=0, dy=1)
    dy_template_crop = scipy.ndimage.affine_transform(dy_template_crop.T,M).T
    ...
    # print("dx_x ARRAY IS", dx_x[0:10,:])
    # print("dy_x ARRAY IS", dy_x[0:10,:])
    # print("xcount is", x_count_arr)
    # print("ycount is", y_count_arr)
