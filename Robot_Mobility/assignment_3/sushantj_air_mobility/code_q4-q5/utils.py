...
def plot_des_vs_track(state, state_des, time_vec, thrust_array=None):
        mass = 0.77
        weight = mass*9.8
        ...
        y_track = fig.add_subplot(332)
        y_track.plot(time_vec, y, 'r', label='Actual position')
        y_track.plot(time_vec, y_des, 'b', label='desired position')
        y_track.set(xlabel = 'time')
        y_track.set(ylabel = 'y (m)')
        y_track.legend()

        z_track = fig.add_subplot(333)
        ...
        acc_track = fig.add_subplot(334)
        acc_track.plot(time_vec, z_acc, 'r', label='actual accel')
        acc_track.plot(time_vec, z_acc_des, 'b', label='desired accel')
        acc_track.set(xlabel = 'time (s)')
        acc_track.set(ylabel = 'z_acc (m/s^2)')
        acc_track.legend()

        vel_track = fig.add_subplot(335)
        vel_track.plot(time_vec, z_vel, 'r', label='actual vel')
        vel_track.plot(time_vec, z_vel_des, 'b', label='desired vel')
